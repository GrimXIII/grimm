...
import strings2 from "./doogleLines"
...
"Subscribe to Vaughan XV for a free Ticonderoga Pencil",
...
"Prank em' John",
"Old meme LOL",
"I can make banana rhyme with orange ornana",
"OMWTFYB",
"cyanide is not healthy to injest",
"now students are not just graded on assignments but also their behaviors! (in my opinion I feel that this is a system that could easily be corrupted)",
"Refresh",
"Don't worry no one can see your dislikes",
"Watch me and my freinds be stupid for a couple hours here: https://www.youtube.com/watch?v=yksUw6xaUxo although the second part I think the school blocked",
"Hi Keegen I can tell you see me editing this",
"Only do steel soul when your confident in you skill",
"Godhome more like god dome? I am still bad at this",
"",
"#yeetthefetus",
"Tell Damen to make Doogle Meet a thing.",
"Hi everybody, Vaughan here. I'm going to be giving a home to the Links Page lines Keegen made from the very beginning of the website's history, so if you see a line that starts with LPL, you know that it is one of Keegen's links page lines.",
"LPL: Grimm's Web Dictionary",
"LPL: Doogle",
"LPL: Grimm, the winner of Uno",
"LPL: NIEN",
"LPL: Ight I tell ya what you fat little cunt",
"LPL: Pico Funny Pico Funny",
"LPL: NES? more like, NE NO!",
"LPL: Doogle 'Russian Dashcam Videos'",
"LPL: Super MAAAAAAAAAAAAAAAAAA-",
"LPL: If u reading this u a furry",
"LPL: Oops! this website is blocked, Reason:web",
"LPL: Among us in real life",
"LPL: *Binding of Issac Referance*",
"LPL: Can I put my balls... in ur jaws",
"LPL: Canvas? more like, Can NO",
"LPL: PS Button, Options, Up, X, Up X",
"LPL: Star Wars? or Star Trek?",
"LPL: DONT LOOK BEHIND YOU!!!",
"LPL: Thats a problem",
"LPL: I has the drip",
"LPL: -10000000000 Social Credit",
"LPL: Doogle, No. Opera GX, Yes!",
"LPL: SHHHHH! Is Securly Watching!??!?!?!?",
"LPL: Hey you! yeah you, yeah you, yeah you.",
"LPL: They put Master Chief in soder!!!",
"LPL: Dont care, plus your female, plus ratio",
"LPL: Oh no! Cringe!",
"LPL: Free V-Bu- I mean Robux no clickbait 100%",
"LPL: What the dog doin?",
"LPL: Ur mom gaeeeeeee",
"LPL: AHHH HES BRITISH!!!",
"LPL: What the dog doin?",
"LPL: Keegen, the winner of UNO",
"psst keep this secret but on the link page when you get to the binding of isaac reference he spelled it wrong XD (The last line like this was by Damen and was referring to the word 'referance.' Apparently he also spelled Isaac 'Isaac' as well. You're welcome Keegen! ~Vaughan XV)"
  //random line of code.  
  //second random line of code that is just vibing.
  //I will find out how to assassinate your mom cuz she do be gay tho.
  //he keegen can you add a "Doogle Master achievment that has an unknown description (???). I will tell you how you would achieve it and you would do that by going to my document that the 'hidden truth' is on. I would appriciate it althoug it isn't required of you"
];
...
function randomSpeed() {
  return strings[Math.floor(Math.random() * speed.length)];
}
...
export default function Home() {
  ...
  const handleChangeHello = () => {
    ...
    const [speed, setSpeed] = React.useState(strings[0]);
  const handleChangeSpeed = () => {
    const newSpeed = randomLanguage();
    setSpeed(newSpeed);
  };
  ...
  //don't know what else I should do with this, but here is the URL for the envelope Damen: https://cdn.glitch.global/3943dd29-ab7d-4dbc-888d-3bca1672b628/Untitled%20drawing%20(1).png?v=1642215398952
  
  return (
    <>
      <br />
      <br />
      <h1 className="title" style={{ fontSize:"70px"}}>{hello}</h1>
      <animated.div>
        <img
          className="doogleIMG"
          src="https://cdn.glitch.global/5608dbda-63e0-48b7-aeef-17abab77528d/Untitled.png?v=1660666365420"
          onClick={handleChangeHello}
          alt="Illustration click to change language"
          style={{ animation: `rotate 6.9s linear infinite` }}
        />
      </animated.div>
      ...
      <iframe
        className="doogle"
        src="https://voracious-buttoned-bottom.glitch.me/"
        width="1300"
        height="700"
      ></iframe>
    </>
